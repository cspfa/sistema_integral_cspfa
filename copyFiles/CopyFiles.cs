...
namespace CopyFiles
{
    ...
    public class CopyFiles
    {
        ...
        public CopyFiles(List<String> sourceFiles, String destination, string ACTION)
        {
        ...
        private void startFirebird()
        {
            ProcessStartInfo PInfo;
            Process P;
            PInfo = new ProcessStartInfo("cmd", @"/c net start FirebirdServerDefaultInstance");
