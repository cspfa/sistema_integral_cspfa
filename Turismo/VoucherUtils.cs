...
namespace SOCIOS.Turismo
{
   public class VoucherUtils
   {
       ...
       {
           string Query = @"select H.ID, H.NOMBRE,L.DESCRIPCION,H.TELEFONO,H.DOMICILIO,H.CHECKIN,H.CHECKOUT,V.REGIMEN,TR.NOMBRE, V.TIPO_HABITACION,HT.TIPO,V.PASAJEROS,V.NOCHES,V.DESDE,V.HASTA,H.OBSERVACIONES,V.NRO_HABITACION NRO_HAB,V.TIPO TIPO ,V.MOTIVO MOTIVO, B.ID_ROL ,B.ROL
