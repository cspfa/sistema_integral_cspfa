...
{
    public partial class ReporteBonoHotel_Blanco : Form
    {   int ID_ROL;
         int ID;
        DateTime Fecha;
              UtilsBono ub;
        ...
        public ReporteBonoHotel_Blanco(int pID_ROL,int pID,DateTime pFecha,   CabeceraTitular pCAB ,string pROL)
        {
            ID_ROL = pID_ROL;
            Fecha = pFecha;
            CAB = pCAB;
        ...
        private void LoadDataReporte()
        {
            ...
            parameters[14] = new ReportParameter("Mail", "");
