...
namespace SOCIOS
{
    public class bo
    {
        ...
        public void BO_EjecutoConsulta(string query)
        {
            datDatos.Ejecuto_Consulta(query);
        }
        ...
        public void SOLICITUD_ALOJAMIENTO_I(DateTime Desde, DateTime Hasta, string Tipo, string Dni, string Nombre, string Apellido, int pNro_Socio, int pNro_Dep, int Barra, int pNro_Adh, int pNro_Dep_Adh, int Plazas, int Tipo_Habitacion,int ID_ROL)
        {
