...
namespace SOCIOS.deportes.Campos
{
    public partial class Exportar_Deportes : Form
    {
        ...
        {
            lista = ds.Importar_Exportar_Deporte(FECHAS.fechaUSA(fechaDesde.Value), FECHAS.fechaUSA(fechaHasta.Value), cbROLES.Text.TrimEnd().TrimStart(),cb_Deportes.Checked);
