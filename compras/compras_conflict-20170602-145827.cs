...
namespace SOCIOS
{
    public partial class compras : Form
    {
        ...
        { 
            ...
            if (PROVEEDOR != 814 && PROVEEDOR != 1089)
            {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            else if (checkCuenta(tbCuenta.Text.Trim()) == true)
            {
                MessageBox.Show("YA EXISTE UN PROVEEDOR CON LA CUENTA INGRESADA", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            else
            {
                string RAZON_SOCIAL = null;
