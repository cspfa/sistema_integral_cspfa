    ...
    public partial class Testing_Facturacion : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {   string DIR =@"c:\CSPFA_SOCIOS\";
                ...
                imp_factura.Genero_PDF((int)SOCIOS.Factura_Electronica.Tipo_Comprobante_Enum.RECIBO_C, 2, 250, System.DateTime.Now, "20340680619", "Consumidor Final", "Sebastian Auladell", "Roosevelt 3443 1431 CABA", 1600, "68399680115324", "20-11-2018","ORIGINAL","CONTADO","");
