...
namespace SOCIOS.Factura_Electronica
{
    public partial class Testing_Facturacion : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           serviceFactura.Facturo_Recibo(ID_RECIBO, Punto_Venta, (int)SOCIOS.Factura_Electronica.Tipo_Comprobante_Enum.RECIBO_C, (int)SOCIOS.Factura_Electronica.Tipo_Doc_Enum.DNI,Documento,Monto, System.DateTime.Now, 1);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {   string DIR =@"c:\CSPFA_SOCIOS\";
                ...
                imp_factura.Genero_PDF((int)SOCIOS.Factura_Electronica.Tipo_Comprobante_Enum.RECIBO_C, 1, 250, System.DateTime.Now, "20340680619", "Consumidor Final", "Sebastian Auladell", 1600, "68399680115324", "20-11-2018","ORIGINAL","",44472);
